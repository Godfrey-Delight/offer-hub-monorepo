            ...
            body: JSON.stringify(
              {
                ...
                data: {
                  id: "key_01HQ7ZX89ABC",
                  key: "ohk_live_9f83a8f7c1e2b4d5e6f7a8b9c0d1e2f3",
                  name: "Production Marketplace API Key",
                  scopes: ["read", "write"],
            ...
            body: JSON.stringify(
              {
                ...
                data: {
                  token: "ohk_tok_e9b7a6c5d4f3e2a1b0c9d8e7f6a5b4c3",
                  userId: "usr_buyer123",
            ...
            body: JSON.stringify(
              {
                ...
                data: {
                  ...
                  amount: "50.00",
                  destination: "GBXF4A7CKUVNLXYZ1234567890ABCDEFGH",
                  transactionHash: "3f8b9e1c2a4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f",
            ...
            body: JSON.stringify(
              {
                ...
                data: {
                  ...
                  amount: "50.00",
                  destinationType: "stellar",
                  transactionHash: "3f8b9e1c2a4d5e6f...",
                  completedAt: "2026-02-18T17:37:12.000Z",
                },
              },
              null,
